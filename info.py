...
BOT_TOKEN = environ.get('BOT_TOKEN', '6639560220:AAGESjM15yXKQVcMDAqNUUCwnnm1stoOoio')

ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '2116648189').split()]
USERNAME = environ.get('USERNAME', "https://telegram.me/Mr_Haryanvi_Jaat")
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002237064392'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/Movies_Zone_Spport')
...
DELETE_CHANNELS = int(environ.get('DELETE_CHANNELS','-1002237064392'))
...
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', '-1002163900860'))
request_channel = environ.get('REQUEST_CHANNEL', '-1001907540026')
REQUEST_CHANNEL = int(request_channel) if request_channel and id_pattern.search(request_channel) else None
UPI_PAY_LOGS = int(environ.get('UPI_PAY_LOGS', '-1002237064392'))
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1001907540026'))
